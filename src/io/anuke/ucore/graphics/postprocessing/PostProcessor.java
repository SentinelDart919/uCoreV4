package io.anuke.ucore.graphics.postprocessing;
...
import io.anuke.ucore.graphics.postprocessing.utils.ItemsManager;
...
public final class PostProcessor implements Disposable {
	...
	public PostProcessor(){
		this(Gdx.graphics.getWidth(), Gdx.graphics.getHeight(), false, true, true);
	}
